...
This project has been designed around the Waveshare ESP32-S3-ETH dev kit. This devkit includes an Ethernet connection, so it's easy to connect to your network
